...
- `qmd check` reports per-collection staleness (files to index, hashes to embed) and exits non-zero when stale; `-c <name>` scopes the check to specific collections.
